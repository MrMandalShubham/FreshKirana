...
| 3 | P3.4 | COD risk & confirmation | ⏳ | | `PENDING` · four bands, WhatsApp + OTP confirmation, thresholds in a table (no deploy), full audit log · **fixed a P3.2 defect: a captured prepaid order was never announced to the store** |
