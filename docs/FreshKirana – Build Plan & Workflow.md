...
| 3 | P3.4 | COD risk & confirmation | ⏳ | | `3a52301` · CI green, deployed · 603 tests · four bands, WhatsApp + OTP, thresholds in a table (no deploy), full audit log · sweep verified executing on GCP · **fixed two shipped defects: prepaid orders never reached the store, and three scheduled jobs were running months-old images** |
