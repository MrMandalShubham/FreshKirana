...
| 3 | P3.3 | Payment failure recovery **+ the pay screens** | ⏳ | | `PENDING` · retry, WhatsApp link, COD conversion, TTL cancellation · **reversed P3.2's cancel-on-failure** and made the idempotency key per attempt |
