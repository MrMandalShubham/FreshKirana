...
| 4 | P4.1 | Substitutions | ⏳ | | `PENDING` · three preferences, ranked options, 10-minute window with refund fallback, price-delta rules · **fixed two shipped defects: the ranker ignored §1.7.2's safety rules, and one template carried two messages** |
